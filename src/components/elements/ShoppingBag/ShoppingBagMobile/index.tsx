  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="flex flex-col justify-start min-h-screen max-w-md mx-auto bg-white rounded-lg p-4 relative">
        ...
        <p className="text-20 font-600 text-gray-800 text-center mb-6 mt-12">
          basket ({cartItems.length})
        </p>
        <div className="flex-1 overflow-y-auto">
          {isEmpty ? (
            <div className="flex flex-col items-center justify-center h-full py-20">
              <p className="font-600 text-18 text-gray-600">Empty bag</p>
              <p className="font-400 text-14 text-gray-500 mt-2">
        ...
        {!isEmpty && (
          <div className="border-t border-gray-300 pt-4 mt-4">
            <div className="flex justify-between text-18 font-600 text-gray-800 mb-3">
              <span>Total:</span>
              <span>£{totalPrice.toFixed(2)}</span>
            </div>
            <button className="w-full rounded-full h-12 bg-black text-white text-18 font-600 hover:bg-gray-900 transition">
              Pay Now
            </button>
          </div>
        )}
