...
const WhatsNew = () => {
  return (
    <>
      <div className="w-full h-[1px] bg-gray-200 mb-15"></div>
        ...
        <div className="w-full">
          ...
          >
            ...
            >
              ...
              <button
                className="
                  py-4 px-8 text-center whitespace-nowrap rounded-full bg-black text-white font-500 absolute bottom-8 left-1/2 -translate-x-1/2 transition-transform duration-500 ease-in-out group-hover:scale-105 hover:bg-gray-500
                "
              >
                BROWSE ECATALOGUE
              </button>
