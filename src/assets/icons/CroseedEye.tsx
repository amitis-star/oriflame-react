...
const VisibilityOffIcon = ({
  ...
  <svg
    className={`MuiSvgIcon-root MuiSvgIcon-fontSizeMedium ori-security-identity-ui-emotion-cache-key-rptbb3 ${className}`}
    focusable="false"
    aria-hidden="true"
    viewBox="0 0 24 24"
    width={width}
    height={height}
    fill={fill}
    data-testid="Acquisition-ori-security-identity-ui-icon-visibilityOff"
    {...props}
  >
